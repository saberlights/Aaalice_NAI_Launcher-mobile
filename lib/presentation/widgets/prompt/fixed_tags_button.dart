...
class _FixedTagsButtonState extends ConsumerState<FixedTagsButton> {
          ...
          ConstrainedBox(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                decorationColor: theme.colorScheme.outline.withValues(alpha: 0.5),
              ),
              overflow: TextOverflow.ellipsis,
            ),
          ),
  ...
  void _showFixedTagsDialog(BuildContext context) {
    showGeneralDialog(
      ...
      barrierLabel: '关闭',
      barrierColor: Colors.black.withValues(alpha: 0.5), // 背景半透明遮罩
      ...
      transitionBuilder: (context, animation, secondaryAnimation, child) {
        return SlideTransition(
          position: Tween<Offset>(
            begin: const Offset(1.0, 0.0), // 动画：从右向左滑入
            end: Offset.zero,
